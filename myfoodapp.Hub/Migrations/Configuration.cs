namespace myfoodapp.Hub.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<myfoodapp.Hub.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
           ...
           //USERS
           //GREENHOUSE OWNERS           
           var userMGA = new ApplicationUser() { Email = "mickael@myfood.eu", UserName = "MGA" };
           var userMUR = new ApplicationUser() { Email = "matthieu@myfood.eu", UserName = "MUR" };
           var userJNA = new ApplicationUser() { Email = "johan@myfood.eu", UserName = "JNA" };

           var userCLA = new ApplicationUser() { Email = "christophe@myfood.eu", UserName = "CLA" };
           var userJPM = new ApplicationUser() { Email = "jean-philippe@myfood.eu", UserName = "JPM" };
           var userRRO = new ApplicationUser() { Email = "rosario@myfood.eu", UserName = "RRO" };
           var userAMA = new ApplicationUser() { Email = "andrew@myfood.eu", UserName = "AMA" };
           var userSCR = new ApplicationUser() { Email = "sebastien@myfood.eu", UserName = "SCR" };
           var userMSV = new ApplicationUser() { Email = "michel@myfood.eu", UserName = "MVS" };
           var userDPR = new ApplicationUser() { Email = "didier@myfood.eu", UserName = "DPR" };
           var userCPE = new ApplicationUser() { Email = "christophe@myfood.eu", UserName = "CPE" };
           var userSCO = new ApplicationUser() { Email = "sabine@myfood.eu", UserName = "SCO" };
           var userPTO = new ApplicationUser() { Email = "philippe@myfood.eu", UserName = "PTO" };
           var userSAS = new ApplicationUser() { Email = "stan@myfood.eu", UserName = "SAS" };
           var userCWI = new ApplicationUser() { Email = "christiane@myfood.eu", UserName = "CWI" };
           var userMWI = new ApplicationUser() { Email = "margot@myfood.eu", UserName = "MWI" };

           //TO BE DEPLOYED
           var userMLA = new ApplicationUser() { Email = "marc@myfood.eu", UserName = "MLA" };
           var userGDE = new ApplicationUser() { Email = "gilles@myfood.eu", UserName = "GDE" };
           var userCDE = new ApplicationUser() { Email = "cristof@myfood.eu", UserName = "CDE" };
           var userPCL = new ApplicationUser() { Email = "pieterjan@myfood.eu", UserName = "PCL" };
           var userAHE = new ApplicationUser() { Email = "amous@myfood.eu", UserName = "AHE" };

           //TO BE CONFIRMED
           var userBGU = new ApplicationUser() { Email = "brigitte@myfood.eu", UserName = "BGU" };
           var userSMA = new ApplicationUser() { Email = "stephane@myfood.eu", UserName = "SMA" };

           //CONTRIBUTORS
           var userJTE = new ApplicationUser() { Email = "joel@myfood.eu", UserName = "JTE" };
           var userAPO = new ApplicationUser() { Email = "anhhung@myfood.eu", UserName = "APO" };
           var userNRO = new ApplicationUser() { Email = "nicolas@myfood.eu", UserName = "NRO" };
           var userCEL = new ApplicationUser() { Email = "cyrille@myfood.eu", UserName = "CEL" };

           var t = Task.Run(async () => {
                //ADD USERS
                //GREENHOUSE OWNERS  
                await manager.CreateAsync(userMGA, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userMUR, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userJNA, "[myfoodhub_XXXXXX]");

                await manager.CreateAsync(userCLA, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userJPM, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userRRO, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userAMA, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userSCR, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userMSV, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userDPR, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userCPE, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userSCO, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userPTO, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userSAS, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userCWI, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userMWI, "[myfoodhub_XXXXXX]");

                //TO BE DEPLOYED
                await manager.CreateAsync(userMLA, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userGDE, "[myfoodhub_XXXXXX]");                
                await manager.CreateAsync(userCDE, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userPCL, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userAHE, "[myfoodhub_XXXXXX]");

                //TO BE CONFIRMED
                await manager.CreateAsync(userBGU, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userSMA, "[myfoodhub_XXXXXX]");

                //CONTRIBUTORS
                await manager.CreateAsync(userJTE, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userAPO, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userNRO, "[myfoodhub_XXXXXX]");
                await manager.CreateAsync(userCEL, "[myfoodhub_XXXXXX]");
